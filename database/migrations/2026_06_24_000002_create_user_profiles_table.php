...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('student_profiles', function (Blueprint $table) {
            ...
            // Use explicit foreign key definitions here.
        ...
        Schema::create('company_profiles', function (Blueprint $table) {
            ...
            // 1. Company owner / main company admin account.
            $table->foreignId('user_id')->constrained('users')->onDelete('cascade');

            // 2. Legal and verification information for admin review.
            $table->string('company_legal_name');
            $table->string('tax_id')->nullable()->unique();
            $table->string('business_registration_path')->nullable();

            // 3. Public branding information shown on job pages.
            ...
            // 4. Official company location and contact information.
            $table->text('hq_address')->nullable();
            $table->string('city')->nullable();
            $table->string('country')->default('Taiwan');
            $table->string('official_email')->nullable();

            // 5. Person in Charge (PIC) / initial registrant information.
