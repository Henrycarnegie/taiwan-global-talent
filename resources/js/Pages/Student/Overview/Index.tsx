        ...
        <div className="space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-slate-900 to-blue-900 p-6 text-white shadow-sm">
                <div className="relative z-10 max-w-2xl">
                    ...
                    <p className="text-sm leading-relaxed text-slate-300">
                        Complete your profile to unlock internships, jobs, and
                        digital incubation programs from Taiwan’s leading
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <Card
                    ...
                    subTitle="投遞進度"
                    value="3"
                    footerText="Taiwanese Companies"
                />
                <Card
                    title="Certificates"
                    subTitle="證書"
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="space-y-3">
                        <div className="cursor-pointer rounded-xl bg-gray-50 p-3 transition hover:bg-gray-100">
                            ...
                            <p className="text-sm font-medium text-gray-800">
                                Registration for international talent officially
                                opens this week.
                            </p>
                        </div>
                        <div className="cursor-pointer rounded-xl bg-gray-50 p-3 transition hover:bg-gray-100">
                            ...
                            <p className="text-sm font-medium text-gray-800">
                                A free TOCFL mock test is available in the
                ...
                <div className="flex flex-col justify-between rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                        ...
                        <div className="space-y-3 text-sm">
                            <p className="text-gray-600">
                                ...
                                <span className="font-medium text-gray-800">
                                    "Does anyone have the latest MOE scholarship
                                    information?"
                                </span>
                            </p>
                            <p className="text-gray-600">
                                💬{' '}
                                <span className="font-medium text-gray-800">
                                    "Sharing an internship experience in
                                    Hsinchu..."
                                </span>
                            </p>
                        </div>
                    ...
                    <button
                        ...
                        className="mt-4 w-full rounded-lg bg-blue-50 p-2 text-center text-xs font-semibold text-blue-600 transition hover:bg-blue-100 hover:text-blue-700"
                    >
                        Open Discussion Forum &rarr;
                    </button>
                </div>
            </div>
        </div>
