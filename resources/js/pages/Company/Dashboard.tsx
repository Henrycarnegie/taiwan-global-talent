...
// 1. Define the interface according to the Company database structure.
interface Company {
    id: number;
    user_id: number;
        ...
        <div>
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    {/* STATE 1: USER DOES NOT HAVE COMPANY DATA YET */}
                    {!company ? (
                        <div className="overflow-hidden border border-amber-200 bg-amber-50 p-6 shadow-sm sm:rounded-lg dark:border-amber-900/30 dark:bg-amber-950/20">
                            ...
                            <p className="mt-2 text-sm text-amber-700 dark:text-amber-300/80">
                                Your account is not connected to any business
                                entity yet. Please complete your legal details
                                and public company profile to start the
                                verification process.
                            </p>
                        </div>
                    ) : (
                        /* STATE 2: COMPANY DATA EXISTS */
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            {/* LEFT SECTION: COMPANY PROFILE SUMMARY */}
                            ...
                            {/* RIGHT SECTION: VERIFICATION STATUS & INFOBAR */}
                            <div className="space-y-6">
                                ...
                                <div className="overflow-hidden border border-gray-200 bg-white shadow-sm sm:rounded-lg dark:border-gray-700 dark:bg-gray-800">
                                    <div className="flex flex-col items-center p-6 text-center">
                                        ...
                                        {/* Show reason if rejected by Filament admin */}
                                        {company.status === 'rejected' &&
